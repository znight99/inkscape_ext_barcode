...
class CompactMatrix(inkex.Effect):
    def __init__(self):
    ...
    def add_arguments(self, pars):
        ...
        pars.add_argument("--segments",
             type=int,
            dest="SEGMENTS", default=1)
    ...
    def effect(self):
        ...
        if so.TEXT == '':  #abort if converting blank text
            ...
            ver=so.VERSION
            seg=so.SEGMENTS
            q= compactmatrix.main.CompactMatrix(version=ver, segments=seg, error_correction=so.ECC)
